    ...
    inline void registerAll(lua_State* L) {
        luabridge::getGlobalNamespace(L)
            ...
            .beginClass<BotClient>("BotClient")
                ...
                .addFunction("getCapacity", &BotClient::getCapacity)
                ...
                .addFunction("getManaPercent", &BotClient::getManaPercent)
                .addFunction("getSkull", [](BotClient* client, uintptr_t creature) { return (int)client->getSkull(creature); })
                .addProperty("getDirection", [](BotClient* client, uintptr_t creature) { return (int)client->getDirection(creature); })
                .addFunction("isDead", &BotClient::isDead)
                .addFunction("isWalking", &BotClient::isWalking)
                ...
                .addFunction("safeLogout", &BotClient::safeLogout)
                ...
                .addFunction("getChaseMode", &BotClient::getChaseMode)
                .addFunction("getFightMode", &BotClient::getFightMode)
